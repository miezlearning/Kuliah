...
-------------------------------------------------------------------------------------------------
""")                
    for items in range(len(praktikan_nama)):
        kolom_1 = str(items+1)
        kolom_2 = str(praktikan_nama[items])
        kolom_3 = str(praktikan_nim[items])
...
def tambahBarang():
    ...
    while (a == False):
        ...
        if(nama_tambah and nim_tambah.isnumeric()):
            ...
            praktikan_nama.append(nama_tambah)
            #Masukan Data NIM Praktikan kedalam List
            praktikan_nim.append(nim_tambah)
        sleep(0.5)
        break
...
def editBarang():
    ...
    if(update.isnumeric()):
        ...
        if(namaA.isalnum() and nimA.isnumeric()):
            ...
            praktikan_nama.pop(update_index)
            praktikan_nim.pop(update_index)
            
                #untuk memasukkan item pada list berdasarkan index yang diinginkan
            praktikan_nama.insert(update_index, namaA)
            praktikan_nim.insert(update_index, nimA)
        sleep(0.5)
    ...
    try :
        while True:
            ...
            if(delete.isnumeric()):
                ...
                praktikan_nama.pop(delete_index)
                praktikan_nim.pop(delete_index)
            sleep(0.5)
            break
    except ValueError:
