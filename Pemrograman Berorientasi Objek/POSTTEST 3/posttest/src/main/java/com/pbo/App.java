...
public class App {
    ...
    public static void menuUtama(User user) {
        ...
        Menu_Player chara = new Menu_Player(role, role, role, percobaan, percobaan, percobaan, percobaan);
        if (pengguna == null) {
...
1. Buat repository dengan nama Praktikum-PBO-2024
2. Masukkan Package/Folder Posttest 2 ke dalam repository 
3. Buat folder repository terlihat seperti gambar yang terlampir

POIN PLUS
1. Menerapkan semua jenis access modifier
2. Menerapkan package dari luar modul dengan memanfaatkan build tools (maven/gradle/ant)

PERHATIAN !!!
1. Jika terindikasi meniru teman (hanya ganti tema, hanya ganti variabel, hanya ganti tipe data, hanya ganti tampilan), Keduanya mendapat nilai E.
2. Jika ingin ubah judul / tema silahkan konfirmasi ke aslab yang mengajar di kelasnya.
 */
