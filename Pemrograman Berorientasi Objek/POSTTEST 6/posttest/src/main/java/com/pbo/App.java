...
public class App {
    ...
    private static final Job[] jobs = {
            new Warrior("Mage", 100, 50, 10, 20),
            new Assassin("Assassin", 80, 40, 20, 10),
            new Fighter("Fighter", 120, 60, 15, 15),
            new Paladin("Paladin", 150, 70, 5, 25)
    };
...
public static void loginAdmin() {
    ...
    try {
        ...
        loginAdmin(); // Memanggil kembali method loginAdmin() untuk memulai kembali proses login.
    }
}
